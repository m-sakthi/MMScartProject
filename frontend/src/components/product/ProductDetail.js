          ...
          <div className="row f-flex justify-content-around">
            ...
            <div className="col-12 col-lg-5 mt-5">
              ...
              <div className="stockCounter d-inline">
                <button className="btn btn-light minus" onClick={decreaseQty}><i class="fa-solid fa-minus"></i></button>
                <input type="number" className="form-control count d-inline ms-4" value={quantity} readOnly />
                <button className="btn btn btn-light plus ms-4" onClick={increaseQty}><i class="fa-solid fa-plus"></i></button>
              </div>
              <button type="button"
                ...
                className="btn btn-primary d-inline ms-6"
              >Add to Cart</button>
